// ЩЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЛ
// К  лллллл  лллллл  лллл  лллллл   лллл  лллллл лллллл  лллл   К
// К   лл  лл лл     лл  лл  лл  лл лл  лл   лл     лл   лл  лл  К
// К   лл  лл лллл   лл  лл  лл  лл лл  лл   лл     лл   лл  лл  К
// К   лл  лл лл     лл  лл  лл  лл лллллл   лл     лл   лллллл  К
// К  лллллл  лллллл  лллл  лллллл  лл  лл   лл     лл   лл  лл  Кthe Author.
// ШЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭМ
...
void GoodBye (void)
{
	...
	for (i = 0;i < 3;i ++)
	{
		...
		delay (100);
		gotoxy (5, 15);cprintf ("ллллл   лллллл   лллл   ллллл   лл  лл    лл      лл    лл  лл ");
		delay (100);
		gotoxy (5, 11);cprintf ("ллллл   лллллл   лллл   ллллл    лллл   лллллл  лллллл   лллл ");
		delay (100);
		gotoxy (5, 14);cprintf ("лл  лл  лл      лл  лл  лл  лл  лллллл    лл      лл    лллллл ");
		delay (100);
		gotoxy (5, 12);cprintf ("лл  лл  лл      лл  лл  лл  лл  лл  лл    лл      лл    лл  лл ");
		delay (100);
		gotoxy (5, 13);cprintf ("лл  лл  лллл    лл  лл  лл  лл  лл  лл    лл      лл    лл  лл ");
		delay (900);
       }
